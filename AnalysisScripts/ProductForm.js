...
var WasteDisposalForm = window.WasteDisposalForm || {};
(function () {
    const FORM_NEW = 1;
    ...
    this.OnLoad = async function (executionContext) {
        ...
        const locationName = formContext.getAttribute("extreme_locationname");
        const OrgDepartment = formContext.getAttribute("extreme_organizationaldepartment");
        const indexNo = formContext.getAttribute("extreme_indexno");
        const contractNo = formContext.getAttribute("extreme_contractno");
