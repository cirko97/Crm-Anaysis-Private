  ...
  $(() => {
      ...
      .dxDataGrid({
        ...
        rowDragging: {
          ...
          async onReorder(e) {
            ...
            const toIndex = quoteLinesData._array.findIndex(
              (item) =>
                item.quotedetailid === visibleRows[e.toIndex].data.quotedetailid
            );
            const fromIndex = quoteLinesData._array.findIndex(
              (item) => item.quotedetailid === e.itemData.quotedetailid
            );
            ...
            for (
              ...
              quoteLinesData._array.filter(
                (item) => item.extreme_parentquoteline === null
              ).length;
              i++
            ) {
              Xrm.WebApi.updateRecord(
                ...
                { sequencenumber: parseInt(i + 1 + "00") }
              );
              quoteLinesData._array.filter(
                (item) => item.extreme_parentquoteline === null
              )[i].sequencenumber = parseInt(i + 1 + "00");
            }
              ...
              .dxDataGrid({
                ...
                rowDragging: {
                  ...
                  async onReorder(e) {
                    ...
                    const toIndex = quoteLinesData._array.findIndex(
                      (item) =>
                        item.quotedetailid ===
                        visibleRows[e.toIndex].data.quotedetailid
                    );
                    const fromIndex = quoteLinesData._array.findIndex(
                      (item) => item.quotedetailid === e.itemData.quotedetailid
                    );
                          ...
                          sequencenumber:
                            quoteLinesData._array.find(
                              (item) =>
                                ...
                                quoteLinesData._array.filter(
                                  (item) =>
                                    item.extreme_parentquoteline !== null
                                )[i].extreme_parentquoteline
                            ).sequencenumber +
                            (i + 1),
                        }
                ...
                columns: [
                  ...
                  },
                  {
                    ...
                    setCellValue: async function (
                      ...
                      if (
                        ...
                        newData.uomid = unitsStore._array.find(
                          (item) =>
                            item.name.toLowerCase() ===
                            primaryDefaultUnit.toLowerCase()
                        ).id;
                        ...
                        newData.manualdiscountamount =
                          recalcResult.manualDiscountAmount;
                        ...
                        newData.extreme_discount =
                          recalcResult.discountPercentage;
                        ...
                        if (value !== null) {
                          ...
                          defaultVatSetting =
                            defaultVatSetting.entities.length > 0
                              ? defaultVatSetting.entities[0]
                                  .extreme_vatsettingid
                              : null;
                        }
                      }
                        ...
                        if (value !== null && isGuid(value)) {
                          ...
                          if (
                            ...
                            priceListItemInfo =
                              await Xrm.WebApi.retrieveMultipleRecords(
                                "productpricelevel",
                                `?$select=amount,_transactioncurrencyid_value&$expand=pricelevelid($select=extreme_defaultsalesmargin)&$filter=(_pricelevelid_value eq ${productInfo._pricelevelid_value} and _productid_value eq ${value})`
                              );
                          } else {
                            var alertStrings = {
                      ...
                      if (classifyLookupsInfo !== null) {
                        ...
                        if (classifyLookupsInfo._extreme_area_value)
                          newData.extreme_area =
                            classifyLookupsInfo._extreme_area_value;
                        if (classifyLookupsInfo._extreme_technology_value)
                          newData.extreme_technology =
                            classifyLookupsInfo._extreme_technology_value;
                        if (classifyLookupsInfo._extreme_supplier_value)
                          newData.extreme_vendorsupplier =
                            classifyLookupsInfo._extreme_supplier_value;
                      }
                      ...
                      const priceListItemAmount = priceListItemInfo.entities
                        ...
                        : 0;
                      const priceListItemAmountFormatted =
                        priceListItemInfo.entities
                          ? priceListItemInfo.entities[0][
                              "amount@OData.Community.Display.V1.FormattedValue"
                            ]
                          : null;
                      ...
                      if (productInfo._defaultuomid_value !== null)
                        newData.uomid = productInfo._defaultuomid_value;
                      if (productInfo._pricelevelid_value && !isAddingSet) {
                        if (priceListItemInfo.entities)
                          newData.extreme_pricelist =
                            productInfo._pricelevelid_value;
                        if (priceListItemInfo.entities)
                          newData.extreme_pricelistpriceperunit =
                            priceListItemAmount;
                        if (priceListItemInfo.entities)
                          newData.extreme_pricelistcurrency =
                            priceListItemCurrency;
                        if (
                          ...
                          newData.extreme_supplierpriceperunit =
                            ...
                            $(
                              `#${
                                currenciesArray.find(
                                  (item) =>
                                    item.currencysymbol == priceListItemCurrency
                                ).isocurrencycode
                              }`
                            ).val();
                      ...
                      if (
                        ...
                        const recalcResult = recalculateAmounts({
                          ...
                          supplierDiscount:
                            currentRowData.extreme_supplierdiscount,
                  ...
                  },
                  {
                    ...
                    editorOptions: {
                      ...
                      onCustomItemCreating: function (args) {
                        ...
                        if (
                          (args.customItem = unitsStore._array.find((item) =>
                            item.name
                              .toLowerCase()
                              .trim()
                              .startsWith(args.text.toLowerCase().trim())
                          ))
                        ) {
                          args.customItem = unitsStore._array.find((item) =>
                            item.name
                  ...
                  },
                  {
                    ...
                    cellTemplate(container, info) {
                      ...
                      return info.data.extreme_pricelistpriceperunit !== null &&
                        info.data.extreme_pricelistpriceperunit !== undefined
                        ? $("<div>").text(
                  ...
                  },
                  {
                    ...
                    customizeText: function (cellInfo) {
                      return cellInfo.valueText === "" ||
                        cellInfo.valueText === null
                        ? cellInfo.valueText
                        : cellInfo.valueText + ` ${quoteCurrencySymbol}`;
                    },
                    visible: dataGrid.columnOption(
                  ...
                  },
                  {
                    ...
                    lookup: {
                      dataSource(options) {
                        ...
                        if (
                          ...
                          isGuid(options.data.productid)
                        ) {
                          const productInfo = Xrm.WebApi.retrieveRecord(
                            "product",
                            `${options.data.productid}`,
                            "?$select=producttypecode"
                          );
                          if (options.isNewRow !== true) {
                            if (productInfo.producttypecode) {
                              filterQuery = [
                                "productTypeCode",
                                "=",
                                productInfo.producttypecode,
                              ];
                            } else if (
                              quoteLinesData._array.find(
                                (item) =>
                                  item.quotedetailid ===
                                  options.data.quotedetailid
                              ).extreme_producttype
                            ) {
                              filterQuery = [
                                "productTypeCode",
                    ...
                    setCellValue: async function (
                      ...
                      newData.extreme_producttype = vatSettingsArray.find(
                        (item) => item.id === value
                      ).productTypeCode;
                      newData.extreme_tax = vatSettingsArray.find(
                        (item) => item.id === value
                      ).vat;
                      const defaultTax = vatSettingsArray.find(
                        (item) => item.id === value
                      ).vat;
                  ...
                  },
                  {
                    ...
                    setCellValue: async function (
                      ...
                      const newOrgPrice = priceListsArray.find(
                        (item) =>
                          item.productid === currentRowData.productid &&
                          item.id === value
                      ).amount_num;
                      const newOrgCurrency = priceListsArray.find(
                        (item) =>
                          item.productid === currentRowData.productid &&
                          item.id === value
                      ).currency_code;
                      const newOrgCurrencyValue = $(`#${newOrgCurrency}`).val()
                        ? parseFloat($(`#${newOrgCurrency}`).val())
                        : 1;
                      const newOrgCurrencySymbol = currenciesArray.find(
                        (item) => item.isocurrencycode == newOrgCurrency
                      ).currencysymbol;
                  ...
                  },
                  {
                    ...
                    lookup: {
                      dataSource: {
                        ...
                        loadMode: "raw",
                        filter: [
                          ["extreme_relationshiptypeext", "=", 424000000],
                          "or",
                          ["extreme_relationshiptypeext", "=", 424000003],
                        ],
                      },
                      displayExpr: "name",
                      valueExpr: "accountid",
                    ...
                    buttons: [
                      {
                        ...
                        onClick(e) {
                          ...
                          const popupContentTemplate = function (item) {
                            if (isDraftStatus) {
                              return $(
                                ...
                                $(
                                  `<textarea class="form-control" id="productDescription" rows="4" style="resize: none;">${
                                    item.extreme_productdescription
                                      ? item.extreme_productdescription.trim()
                                      : ""
                                  }</textarea>`
                                )
                              );
                          ...
                          const popup = $("#popup")
                            .dxPopup({
                              ...
                              title: `Description for ${
                                e.row.data.extreme_customproductname
                                  ? e.row.data.extreme_customproductname
                                      .length > 20
                                    ? e.row.data.extreme_customproductname.substring(
                                        0,
                                        17
                                      ) + "..."
                                    : e.row.data.extreme_customproductname
                              ...
                              toolbarItems: [
                                {
                                  ...
                                  options: {
                                    ...
                                    async onClick() {
                                      ...
                                      var record = {};
                                      record.extreme_productdescription =
                                        "test"; // Multiline Text
                          ...
                          popup.option({
                            contentTemplate: () =>
                              popupContentTemplate(e.row.data),
                          });
                          popup.show();
                        },
                      },
                ...
                onEditorPreparing: async (e) => {
                  ...
                  if (
                    e.dataField == "extreme_supplierdiscount" ||
                    e.dataField == "extreme_discount" ||
                    e.dataField == "extreme_tax"
                  ) {
                  ...
                  if (
                    (e.dataField == "extreme_pricelist" &&
                      (!e.row.data.productid ||
                        typeof e.row.data.productid === "number")) ||
                    e.row.isNewRow
                  ) {
                ...
                onRowPrepared: async (e) => {
                  ...
                  if (
                    ...
                    (e.data.extreme_area === null ||
                      e.data.extreme_area === undefined ||
                      e.data.extreme_technology === null ||
                      e.data.extreme_technology === undefined ||
                      e.data.extreme_vendorsupplier === null ||
                      e.data.extreme_vendorsupplier === undefined)
                  ) {
                ...
                onRowUpdating: async (e) => {
                  ...
                  if (e.newData.productid)
                    ...
                    ] = `/products(${e.newData.productid})`; // Lookup
                  if (e.newData.extreme_customproductname)
                    record.extreme_customproductname =
                      e.newData.extreme_customproductname; // Text
                  if (e.newData.extreme_productdescription)
                    record.extreme_productdescription =
                      e.newData.extreme_productdescription; // Text
                  if (
                    e.newData.extreme_pricelistpriceperunit ||
                    e.newData.extreme_pricelistpriceperunit === 0
                  )
                    record.extreme_pricelistpriceperunit =
                      e.newData.extreme_pricelistpriceperunit; // Decimal
                  if (e.newData.extreme_pricelistcurrency)
                    record.extreme_pricelistcurrency =
                      e.newData.extreme_pricelistcurrency; // Text
                  if (
                    e.newData.extreme_supplierpriceperunit ||
                    e.newData.extreme_supplierpriceperunit === 0
                  )
                    record.extreme_supplierpriceperunit = Number(
                      parseFloat(
                        e.newData.extreme_supplierpriceperunit
                      ).toFixed(4)
                    ); // Currency
                  if (e.newData.quantity || e.newData.quantity === 0)
                    record.quantity = e.newData.quantity; // Decimal
                  if (
                    e.newData.extreme_supplierbaseamount ||
                    e.newData.extreme_supplierbaseamount === 0
                  )
                    record.extreme_supplierbaseamount = Number(
                      parseFloat(e.newData.extreme_supplierbaseamount).toFixed(
                        4
                      )
                    ); // Currency
                  if (
                    e.newData.extreme_supplierdiscount ||
                    e.newData.extreme_supplierdiscount === 0
                  )
                    record.extreme_supplierdiscount =
                      e.newData.extreme_supplierdiscount; // Decimal
                  if (
                    e.newData.extreme_margin ||
                    e.newData.extreme_margin === 0
                  )
                    record.extreme_margin = e.newData.extreme_margin; // Decimal
                  if (e.newData.priceperunit || e.newData.priceperunit === 0)
                    record.priceperunit = e.newData.priceperunit; // Decimal
                  if (e.newData.baseamount || e.newData.baseamount === 0)
                    record.baseamount = e.newData.baseamount; // Decimal
                  if (
                    e.newData.extreme_discount ||
                    e.newData.extreme_discount === 0
                  )
                    record.extreme_discount = e.newData.extreme_discount; // Decimal
                  if (
                    e.newData.manualdiscountamount ||
                    e.newData.manualdiscountamount === 0
                  )
                    record.manualdiscountamount = Number(
                      parseFloat(e.newData.manualdiscountamount).toFixed(4)
                    ); // Currency
                  if (
                    e.newData.extreme_pricewithdiscount ||
                    e.newData.extreme_pricewithdiscount === 0
                  )
                    record.extreme_pricewithdiscount =
                      e.newData.extreme_pricewithdiscount; // Decimal
                  if (
                    e.newData.extreme_fullpricewithdiscount ||
                    e.newData.extreme_fullpricewithdiscount === 0
                  )
                    record.extreme_fullpricewithdiscount =
                      e.newData.extreme_fullpricewithdiscount; // Decimal
                  if (e.newData.extreme_tax || e.newData.extreme_tax === 0)
                    record.extreme_tax = e.newData.extreme_tax; // Decimal
                  if (e.newData.tax || e.newData.tax === 0)
                    record.tax = Number(parseFloat(e.newData.tax).toFixed(4)); // Currency
                  if (e.newData.extreme_pd || e.newData.extreme_pd === 0)
                    record.extreme_pd = e.newData.extreme_pd; // Decimal
                  if (
                    e.newData.extreme_fullpd ||
                    e.newData.extreme_fullpd === 0
                  )
                    record.extreme_fullpd = e.newData.extreme_fullpd; // Decimal
                  if (
                    e.newData.extendedamount ||
                    e.newData.extendedamount === 0
                  )
                    record.extendedamount = e.newData.extendedamount; // New total amount
                  if (typeof e.newData.extreme_createasset === "boolean")
                    record.extreme_createasset = e.newData.extreme_createasset; // Boolean
                  if (e.newData.extreme_pricelist)
                    record[
                      "extreme_pricelist@odata.bind"
                    ] = `/pricelevels(${e.newData.extreme_pricelist})`; // Lookup
                  if (e.newData.extreme_vatsetting) {
                    record[
                      "extreme_VATSetting@odata.bind"
                    ] = `/extreme_vatsettings(${e.newData.extreme_vatsetting})`; // Lookup
                    record[
                      "extreme_VATGroup@odata.bind"
                    ] = `/extreme_vatgroups(${
                      vatSettingsArray.find(
                        (item) => item.id === e.newData.extreme_vatsetting
                      ).idVatGroup
                    })`; // Lookup
                  }
                  if (e.newData.extreme_producttype)
                    record.extreme_producttype = e.newData.extreme_producttype; // Chooice

                  if (!typeof e.oldData.productid === "number") {
                    if (e.newData.uomid)
                      record["uomid@odata.bind"] = `/uoms(${e.newData.uomid})`; // Lookup
                  }
                  ...
                  if (e.oldData.extreme_parentquoteline) {
                    ...
                    quoteLinesData._array
                      .filter(
                        (item) =>
                          item.extreme_parentquoteline ===
                          e.oldData.extreme_parentquoteline
                      )
                      .forEach((e) => {
                        ...
                        extreme_supplierbaseamount_sum +=
                          e.extreme_supplierbaseamount;
                        tax_sum += e.tax;
                      });
                ...
                onRowRemoving: async (e) => {
                  ...
                  if (e.data.extreme_parentquoteline) {
                    ...
                    quoteLinesData._array
                      .filter(
                        (item) =>
                          item.extreme_parentquoteline === parentQuoteLineGUID
                      )
                      .forEach((e) => {
                        baseamount_sum += e.baseamount;
                        extendedamount_sum += e.extendedamount;
                    ...
                    dataGrid.getController("data").updateItems({
                      changeType: "update",
                      rowIndices: [
                        dataGrid.getRowIndexByKey(parentQuoteLineGUID),
                      ],
                    });
                  }
                ...
                onCellDblClick(e) {
                  ...
                  if (
                    e.column.dataField === "productid" &&
                    isGuid(e.data.productid) &&
                    e.data.productid
                  ) {
                    ...
                    link.href = `${globalContext.getCurrentAppUrl()}&pagetype=entityrecord&etn=product&id=${
                      e.data.productid
                    }`;
                    link.target = "_blank";
                  ...
                  if (
                    e.column.dataField === "extreme_customproductname" &&
                    isGuid(e.data.productid)
                  ) {
        ...
        columns: [
          ...
          },
          {
            ...
            setCellValue: async function (newData, value, currentRowData) {
              if (
                ...
                newData.uomid = unitsStore._array.find(
                  (item) =>
                    item.name.toLowerCase() === primaryDefaultUnit.toLowerCase()
                ).id;
              ...
              const priceListItemAmount = priceListItemInfo.entities
                ? priceListItemInfo.entities[0].amount
                : 0;
              const priceListItemAmountFormatted = priceListItemInfo.entities
                ? priceListItemInfo.entities[0][
                    "amount@OData.Community.Display.V1.FormattedValue"
                  ]
                : null;
              const priceListItemCurrency = priceListItemInfo.entities
                ? currenciesArray.find(
                    (item) =>
                      item.transactioncurrencyid ===
                      priceListItemInfo.entities[0]._transactioncurrencyid_value
                  ).currencysymbol
                : null;
                ...
                if (
                  ...
                  newData.extreme_supplierpriceperunit =
                    ...
                    $(
                      `#${
                        currenciesArray.find(
                          (item) => item.currencysymbol == priceListItemCurrency
                        ).isocurrencycode
                      }`
                    ).val();
                  supplierPricePerUnit =
          ...
          },
          {
            ...
            customizeText: function (cellInfo) {
              return cellInfo.valueText === "" || cellInfo.valueText === null
                ? cellInfo.valueText
                : cellInfo.valueText + ` ${quoteCurrencySymbol}`;
            },
          },
                ...
                if (
                  ...
                  if (options.isNewRow !== true) {
                    if (productInfo.producttypecode) {
                      ...
                      quoteLinesData._array.find(
                        (item) =>
                          item.quotedetailid === options.data.quotedetailid
                      ).extreme_producttype
                    ) {
                      filterQuery = [
                        "productTypeCode",
                ...
                if (
                  ...
                  quoteLinesData._array
                    .filter(
                      (item) =>
                        item.extreme_parentquoteline ===
                        currentRowData.quotedetailid
                    )
                    .forEach((elm) => {
                      Xrm.WebApi.updateRecord(
                        "quotedetail",
                        `${elm.quotedetailid}`,
                        { extreme_createasset: value }
                      );
                ...
                onClick(e) {
                  ...
                  const popup = $("#popup")
                    .dxPopup({
                      ...
                      title: `Description for ${
                        e.row.data.extreme_customproductname
                          ? e.row.data.extreme_customproductname.length > 20
                            ? e.row.data.extreme_customproductname.substring(
                                0,
                                17
                              ) + "..."
                      ...
                      toolbarItems: [
                        {
                          ...
                          options: {
                            ...
                            async onClick() {
                              ...
                              quoteLinesData.update(e.row.data.quotedetailid, {
                                extreme_productdescription: $(
                                  "#productDescription"
                                )
                                  .val()
        ...
        onRowPrepared: async (e) => {
          ...
          if (
            ...
            e.rowType === "data" &&
            $("#classifyBtn").dxButton("instance").option("disabled") === true
          ) {
            e.cells[1].cellElement[0].childNodes[0].classList.remove(
              "dx-datagrid-group-closed"
            );
        ...
        onEditorPreparing: async (e) => {
          ...
          if (
            (e.row.data.extreme_isparentitem === true ||
              (isAddingSet && e.row.isNewRow)) &&
        ...
        onInitNewRow: async (e) => {
          ...
          if (!isAddingSet) {
            ...
            dataGrid.columnOption("extreme_vatsetting", "validationRules", [
              { type: "required" },
            ]);
          } else {
            e.data.extreme_isparentitem = true;
        ...
        onRowInserting: async (e) => {
          ...
          if (e.data.extreme_customproductname)
            record.extreme_customproductname = e.data.extreme_customproductname; // Text
          if (
            e.data.extreme_pricelistpriceperunit ||
            e.data.extreme_pricelistpriceperunit === 0
          )
            record.extreme_pricelistpriceperunit =
              e.data.extreme_pricelistpriceperunit; // Decimal
          if (e.data.extreme_pricelistcurrency)
            record.extreme_pricelistcurrency = e.data.extreme_pricelistcurrency; // Text
          if (
            e.data.extreme_supplierpriceperunit ||
            e.data.extreme_supplierpriceperunit === 0
          )
            record.extreme_supplierpriceperunit = Number(
              parseFloat(e.data.extreme_supplierpriceperunit).toFixed(4)
            ); // Currency
          if (e.data.quantity || e.data.quantity === 0)
            record.quantity = e.data.quantity; // Decimal
          if (
            e.data.extreme_supplierbaseamount ||
            e.data.extreme_supplierbaseamount === 0
          )
            record.extreme_supplierbaseamount = Number(
              parseFloat(e.data.extreme_supplierbaseamount).toFixed(4)
            ); // Currency
          if (
            e.data.extreme_supplierdiscount ||
            e.data.extreme_supplierdiscount === 0
          )
            record.extreme_supplierdiscount = e.data.extreme_supplierdiscount; // Decimal
          if (e.data.extreme_margin || e.data.extreme_margin === 0)
            record.extreme_margin = e.data.extreme_margin; // Decimal
          if (e.data.priceperunit || e.data.priceperunit === 0)
            record.priceperunit = e.data.priceperunit; // Decimal
          if (e.data.baseamount || e.data.baseamount === 0)
            record.baseamount = e.data.baseamount; // Decimal
          if (e.data.extreme_discount || e.data.extreme_discount === 0)
            record.extreme_discount = e.data.extreme_discount; // Decimal
          if (e.data.manualdiscountamount || e.data.manualdiscountamount === 0)
            record.manualdiscountamount = Number(
              parseFloat(e.data.manualdiscountamount).toFixed(4)
            ); // Currency
          if (
            e.data.extreme_pricewithdiscount ||
            e.data.extreme_pricewithdiscount === 0
          )
            record.extreme_pricewithdiscount = e.data.extreme_pricewithdiscount; // Decimal
          if (
            e.data.extreme_fullpricewithdiscount ||
            e.data.extreme_fullpricewithdiscount === 0
          )
            record.extreme_fullpricewithdiscount =
              e.data.extreme_fullpricewithdiscount; // Decimal
          if (e.data.extreme_tax || e.data.extreme_tax === 0)
            record.extreme_tax = e.data.extreme_tax; // Decimal
          if (e.data.tax || e.data.tax === 0)
            record.tax = Number(parseFloat(e.data.tax).toFixed(4)); // Currency
          if (e.data.extreme_pd || e.data.extreme_pd === 0)
            record.extreme_pd = e.data.extreme_pd; // Decimal
          if (e.data.extreme_fullpd || e.data.extreme_fullpd === 0)
            record.extreme_fullpd = e.data.extreme_fullpd; // Decimal
          if (typeof e.data.extreme_createasset === "boolean")
            record.extreme_createasset = e.data.extreme_createasset; // Boolean
          if (e.data.extreme_pricelist)
            record[
              "extreme_pricelist@odata.bind"
            ] = `/pricelevels(${e.data.extreme_pricelist})`; // Lookup
          if (e.data.extreme_producttype)
            record.extreme_producttype = e.data.extreme_producttype; // Choice
          if (e.data.extreme_area)
            record[
              "extreme_Area@odata.bind"
            ] = `/extreme_areas(${e.data.extreme_area})`; // Lookup
          if (e.data.extreme_technology)
            record[
              "extreme_Technology@odata.bind"
            ] = `/extreme_technologies(${e.data.extreme_technology})`; // Lookup
          if (e.data.extreme_vendorsupplier)
            record[
              "extreme_VendorSupplier@odata.bind"
            ] = `/accounts(${e.data.extreme_vendorsupplier})`; // Lookup
          if (e.data.extreme_vatsetting) {
            record[
              "extreme_VATSetting@odata.bind"
            ] = `/extreme_vatsettings(${e.data.extreme_vatsetting})`; // Lookup
            record["extreme_VATGroup@odata.bind"] = `/extreme_vatgroups(${
              vatSettingsArray.find(
                (item) => item.id === e.data.extreme_vatsetting
              ).idVatGroup
            })`; // Lookup
          }
          ...
          isAddingSet
            ? (record.extreme_isparentitem = true)
            : (record.extreme_isparentitem = false);

          if (e.data.productid) {
            if (typeof e.data.productid === "number") {
              record.extreme_customproductid = customProductsStore._array.find(
                (item) => item.productid === e.data.productid
              ).name;
              if (e.data.uomid) {
                if (typeof e.data.uomid === "number") {
                  record.extreme_uomid = unitsStore._array.find(
                    (item) => item.id === e.data.uomid
                  ).name;
                } else {
                  record.extreme_uomid = unitsStore._array.find(
                    (item) => item.id === e.data.uomid
              ...
              const existingProductLookups = await Xrm.WebApi.retrieveRecord(
                "product",
                `${e.data.productid}`,
                "?$select=description,_extreme_area_value,_extreme_supplier_value,_extreme_technology_value"
              );
              // console.log('EXISTING PRODUCT LOOKUPS');
              // console.log(existingProductLookups);
              if (existingProductLookups._extreme_area_value)
                record[
                  "extreme_Area@odata.bind"
                ] = `/extreme_areas(${existingProductLookups._extreme_area_value})`; // Lookup
              if (existingProductLookups._extreme_technology_value)
                record[
                  "extreme_Technology@odata.bind"
                ] = `/extreme_technologies(${existingProductLookups._extreme_technology_value})`; // Lookup
              if (existingProductLookups._extreme_vendorsupplier_value)
                record[
                  "extreme_VendorSupplier@odata.bind"
                ] = `/accounts(${existingProductLookups._extreme_vendorsupplier_value})`; // Lookup
              if (e.data.extreme_productdescription) {
                record.extreme_productdescription =
                  e.data.extreme_productdescription;
              } else {
                record.extreme_productdescription =
                  existingProductLookups.description;
              } // Text
          ...
          await Xrm.WebApi.createRecord("quotedetail", record).then(
            async function success(result) {
              ...
              if (quoteLinesData._array.length > 0) {
                ...
                quoteLinesData._array[
                  quoteLinesData._array.length - 1
                ].quotedetailid = newId;
                quoteLinesData._array[
                  quoteLinesData._array.length - 1
                ].extreme_productdescription =
                ...
                if (quoteLinesData._array._dataByKeyMap) {
                  ...
                  if (quoteLinesData._array._dataByKeyMap[lastKey]) {
                    ...
                    quoteLinesData._array._dataByKeyMap[`"${newId}"`] = {
                      ...quoteLinesData._array._dataByKeyMap[lastKey],
                      quotedetailid: newId,
                    };
                ...
                await Xrm.WebApi.updateRecord("quotedetail", `${newId}`, {
                ...
                quoteLinesData._array[
                  quoteLinesData._array.length - 1
                ].extreme_isparentitem = isAddingSet;
                if (
                  !quoteLinesData._array[quoteLinesData._array.length - 1]
                    .baseamount
                )
                  quoteLinesData._array[
                    quoteLinesData._array.length - 1
                ...
                if (
                  ...
                  quoteLinesData._array[
                    quoteLinesData._array.length - 1
                  ].extreme_fullpricewithdiscount = 0;
                if (
                  !quoteLinesData._array[quoteLinesData._array.length - 1]
                    .manualdiscountamount
                )
                ...
                if (
                  ...
                  quoteLinesData._array[
                    quoteLinesData._array.length - 1
                  ].extreme_supplierbaseamount = 0;
                if (
                  !quoteLinesData._array[quoteLinesData._array.length - 1].tax
                )
                  quoteLinesData._array[
                    quoteLinesData._array.length - 1
                  ].tax = 0;
                ...
                await Xrm.WebApi.updateRecord("quotedetail", `${newId}`, {
                  extendedamount: Number(
                    parseFloat(e.data.extendedamount).toFixed(4)
                  ),
                });

                await Xrm.WebApi.updateRecord("quotedetail", `${newId}`, {
                  baseamount: Number(parseFloat(e.data.baseamount).toFixed(4)),
                });
                ...
                if (
                  ...
                  await Xrm.WebApi.retrieveMultipleRecords(
                    "product",
                    `?$select=productid,description,_pricelevelid_value,_defaultuomid_value,extreme_isparent,name,_extreme_parentproduct_value,productnumber&$filter=_extreme_parentproduct_value eq ${e.data.productid}`
                  ).then(
                    async function success(results) {
                      ...
                      for (var i = 0; i < results.entities.length; i++) {
                        ...
                        var defaultuomid_formatted =
                          result[
                            "_defaultuomid_value@OData.Community.Display.V1.FormattedValue"
                          ];
                        var defaultuomid_lookuplogicalname =
                          result[
                            "_defaultuomid_value@Microsoft.Dynamics.CRM.lookuplogicalname"
                          ];
                        var extreme_isparent = result["extreme_isparent"]; // Boolean
                        var extreme_isparent_formatted =
                          result[
                            "extreme_isparent@OData.Community.Display.V1.FormattedValue"
                          ];
                        var name = result["name"]; // Text
                        var extreme_parentproduct =
                          result["_extreme_parentproduct_value"]; // Lookup
                        var extreme_parentproduct_formatted =
                          result[
                            "_extreme_parentproduct_value@OData.Community.Display.V1.FormattedValue"
                          ];
                        var extreme_parentproduct_lookuplogicalname =
                          result[
                            "_extreme_parentproduct_value@Microsoft.Dynamics.CRM.lookuplogicalname"
                          ];
                        var productnumber = result["productnumber"]; // Text
                        var producttypecode = result["producttypecode"]; // Choice
                        var producttypecode_formatted =
                          result[
                        ...
                        if (isGuid(productid)) {
                          if (productid !== null) {
                            ...
                            defaultVatSetting =
                              await Xrm.WebApi.retrieveMultipleRecords(
                                "extreme_vatsetting",
                                `?$select=extreme_vatsettingid&$filter=(extreme_producttype eq ${productType} and extreme_customertaxpercentage eq ${taxPercentOfAccount.extreme_tax})`
                              );
                            defaultVatSetting =
                              defaultVatSetting.entities.length > 0
                                ? defaultVatSetting.entities[0]
                        ...
                        if (productInfo._pricelevelid_value) {
                          if (productid !== null) {
                            priceListItemInfo =
                              await Xrm.WebApi.retrieveMultipleRecords(
                                "productpricelevel",
                                `?$select=amount,_transactioncurrencyid_value&$filter=(_pricelevelid_value eq ${productInfo._pricelevelid_value} and _productid_value eq ${productid})&$expand=pricelevelid($select=extreme_defaultsalesmargin)`
                              );
                            classifyLookupsInfo =
                        ...
                        if (classifyLookupsInfo !== null) {
                          if (classifyLookupsInfo.producttypecode)
                            productType = classifyLookupsInfo.producttypecode;
                          if (classifyLookupsInfo._extreme_area_value)
                            area = classifyLookupsInfo._extreme_area_value;
                          if (classifyLookupsInfo._extreme_technology_value)
                            technology =
                              classifyLookupsInfo._extreme_technology_value;
                          if (classifyLookupsInfo._extreme_supplier_value)
                        ...
                        if (defaultVatSetting !== null) {
                          ...
                          vatGroup = vatSettingsArray.find(
                            (item) => item.id === defaultVatSetting
                          ).idVatGroup;
                        }

                        if (productInfo._defaultuomid_value !== null)
                          defaultUomid = productInfo._defaultuomid_value;
                        if (productInfo._pricelevelid_value) {
                        ...
                        // additional fields
                        if (productType)
                          record.extreme_producttype = productType; // Choice
                        if (vatSetting)
                          record[
                            "extreme_VATSetting@odata.bind"
                          ] = `/extreme_vatsettings(${vatSetting})`; // Lookup
                        if (taxAmount)
                          record.tax = Number(parseFloat(taxAmount).toFixed(4)); // Currency
                        if (defaultTax) record.extreme_tax = defaultTax; // Decimal
                        if (area)
                          record[
                            "extreme_Area@odata.bind"
                          ] = `/extreme_areas(${area})`; // Lookup
                        if (technology)
                          record[
                            "extreme_Technology@odata.bind"
                          ] = `/extreme_technologies(${technology})`; // Lookup
                        if (vendorSupplier)
                          record[
                            "extreme_VendorSupplier@odata.bind"
                          ] = `/accounts(${vendorSupplier})`; // Lookup
                        if (vatGroup)
                          record[
                            "extreme_VATGroup@odata.bind"
                          ] = `/extreme_vatgroups(${vatGroup})`; // Lookup
                        if (priceList)
                          record[
                            "extreme_pricelist@odata.bind"
                          ] = `/pricelevels(${priceList})`; // Lookup
                        if (priceListPPU)
                          record.extreme_pricelistpriceperunit = priceListPPU; // Decimal
                        if (priceListCurrecy)
                          record.extreme_pricelistcurrency = priceListCurrecy; // Text
                        if (discountAmount)
                          Number(parseFloat(discountAmount).toFixed(4)); // Currency
                        if (pd) record.extreme_pd = pd; // Decimal
                        if (fullPD) record.extreme_fullpd = fullPD; // Decimal
                        if (supplierBaseAmount)
                          record.extreme_supplierbaseamount =
                            supplierBaseAmount; // Decimal
                        if (quantity) record.quantity = quantity; // Decimal
                        if (fullPriceWithDiscount)
                          record.extreme_fullpricewithdiscount =
                            fullPriceWithDiscount; // Decimal
                        if (PPU)
                          record.priceperunit = Number(
                            parseFloat(PPU).toFixed(4)
                          ); // Currency
                        record.extreme_discount = 0; // Decimal
                        record.extreme_supplierdiscount = 0; // Decimal
                        if (priceListMargin)
                          record.extreme_margin = priceListMargin; // Decimal
                        if (supplierPricePerUnit)
                          record.extreme_supplierpriceperunit =
                            supplierPricePerUnit; // Decimal
                        if (description)
                          record.extreme_productdescription = description; // Multi-line Text

                        record[
                          "quoteid@odata.bind"
                        ] = `/quotes(${quoteIdForm})`; // Lookup
                        ...
                        await Xrm.WebApi.createRecord(
                          ...
                          async function success(result) {
                            ...
                            var record = {};
                            if (baseAmount)
                              record.baseamount = Number(
                                parseFloat(baseAmount).toFixed(4)
                              ); // Currency
                            if (extendedAmount)
                              record.extendedamount = Number(
                                parseFloat(extendedAmount).toFixed(4)
                              ); // Currency
                        ...
                        // additional fields
                        if (productType)
                          recordForStore.extreme_producttype = productType; // Choice
                        if (vatSetting)
                          recordForStore.extreme_vatsetting = vatSetting; // Lookup
                        ...
                        if (technology)
                          recordForStore.extreme_technology = technology; // Lookup
                        if (vendorSupplier)
                          recordForStore.extreme_vendorsupplier =
                            vendorSupplier; // Lookup
                        if (vatGroup)
                          recordForStore.extreme_vatgroup = vatGroup; // Lookup
                        if (priceList)
                          recordForStore.extreme_pricelist = priceList; // Lookup
                        if (priceListPPU)
                          recordForStore.extreme_pricelistpriceperunit =
                            priceListPPU; // Decimal
                        if (priceListCurrecy)
                          recordForStore.extreme_pricelistcurrency =
                            priceListCurrecy; // Text
                        if (discountAmount)
                          recordForStore.manualdiscountamount = discountAmount; // Currency
                        if (pd) recordForStore.extreme_pd = pd; // Decimal
                        if (fullPD) recordForStore.extreme_fullpd = fullPD; // Decimal
                        if (supplierBaseAmount)
                          recordForStore.extreme_supplierbaseamount =
                            supplierBaseAmount; // Decimal
                        if (quantity) recordForStore.quantity = quantity; // Decimal
                        if (fullPriceWithDiscount)
                          recordForStore.extreme_fullpricewithdiscount =
                            fullPriceWithDiscount; // Decimal
                        ...
                        if (priceListMargin)
                          recordForStore.extreme_margin = priceListMargin; // Decimal
                        if (baseAmount) recordForStore.baseamount = baseAmount; // Currency
                        if (extendedAmount)
                          recordForStore.extendedamount = extendedAmount; // Currency
                        if (supplierPricePerUnit)
                          recordForStore.extreme_supplierpriceperunit =
                            supplierPricePerUnit; // Decimal
                        if (description)
                          recordForStore.extreme_productdescription =
                        ...
                        if (supplierBaseAmount)
                          quoteLinesData._array.find(
                            (item) => item.quotedetailid === newId
                          ).extreme_supplierbaseamount += supplierBaseAmount;
                        if (taxAmount)
                          quoteLinesData._array.find(
                            (item) => item.quotedetailid === newId
                          ).tax += taxAmount;
        ...
        onRowUpdating: async (e) => {
          ...
          if (
            ...
            record.extreme_pricelistpriceperunit =
              e.newData.extreme_pricelistpriceperunit; // Decimal
          if (
            e.newData.extreme_pricelistcurrency ||
            e.newData.extreme_pricelistcurrency === 0
          )
            record.extreme_pricelistcurrency =
              e.newData.extreme_pricelistcurrency; // Text
          if (
            ...
            record.extreme_supplierpriceperunit = Number(
              parseFloat(e.newData.extreme_supplierpriceperunit).toFixed(4)
            ); // Currency
          if (e.newData.quantity || e.newData.quantity === 0)
            record.quantity = e.newData.quantity; // Decimal
          if (
            ...
            record.extreme_supplierbaseamount = Number(
              parseFloat(e.newData.extreme_supplierbaseamount).toFixed(4)
            ); // Currency
          if (
            e.newData.extreme_supplierdiscount ||
            e.newData.extreme_supplierdiscount === 0
            ...
            record.extreme_supplierdiscount =
              e.newData.extreme_supplierdiscount; // Decimal
          if (e.newData.extreme_margin || e.newData.extreme_margin === 0)
            record.extreme_margin = e.newData.extreme_margin; // Decimal
          if (e.newData.priceperunit || e.newData.priceperunit === 0)
            record.priceperunit = e.newData.priceperunit; // Decimal
          if (
            (e.newData.baseamount || e.newData.baseamount === 0) &&
            e.oldData.extreme_isparentitem !== true
          )
            record.baseamount = e.newData.baseamount; // Decimal
          if (
            e.newData.manualdiscountamount ||
          ...
          if (e.newData.extreme_pd || e.newData.extreme_pd === 0)
            record.extreme_pd = e.newData.extreme_pd; // Decimal
          if (e.newData.extreme_fullpd || e.newData.extreme_fullpd === 0)
            record.extreme_fullpd = e.newData.extreme_fullpd; // Decimal
          if (e.newData.extendedamount || e.newData.extendedamount === 0)
            record.extendedamount = e.newData.extendedamount; // New total amount
          if (typeof e.newData.extreme_createasset === "boolean")
            record.extreme_createasset = e.newData.extreme_createasset; // Boolean
          if (e.newData.extreme_pricelist)
          ...
          if (e.newData.extreme_producttype)
            record.extreme_producttype = e.newData.extreme_producttype; // Chooice
          if (e.newData.extreme_area)
            record[
              "extreme_Area@odata.bind"
            ] = `/extreme_areas(${e.newData.extreme_area})`; // Lookup
          if (e.newData.extreme_technology)
            record[
              "extreme_Technology@odata.bind"
            ] = `/extreme_technologies(${e.newData.extreme_technology})`; // Lookup
          if (e.newData.extreme_vendorsupplier)
            record[
              "extreme_VendorSupplier@odata.bind"
            ] = `/accounts(${e.newData.extreme_vendorsupplier})`; // Lookup
          if (e.newData.extreme_vatsetting) {
            record[
              "extreme_VATSetting@odata.bind"
            ] = `/extreme_vatsettings(${e.newData.extreme_vatsetting})`; // Lookup
          ...
          if (
            isGuid(e.oldData.productid) &&
            (e.newData.extreme_area ||
              e.newData.extreme_technology ||
              e.newData.extreme_vendorsupplier)
          ) {
          ...
          if (
            ...
            function adjustProportionalAmounts(newTotal, amounts) {
              ...
              let adjustedAmounts = amounts.map(
              ...
              if (difference !== 0) {
                ...
                const fractionalAdjustment =
                  Math.round((difference / numChildren) * 100) / 100;

                adjustedAmounts = adjustedAmounts.map(
                  (amount) =>
                    Math.round((amount + fractionalAdjustment) * 100) / 100
                );
                ...
                if (Math.abs(difference) > 0) {
                  const smallestIndex = adjustedAmounts.findIndex(
                    (amount) => amount === Math.min(...adjustedAmounts)
                  );
                  adjustedAmounts[smallestIndex] =
                    Math.round(
                      (adjustedAmounts[smallestIndex] + difference) * 100
                    ) / 100;
                }
              }
            ...
            const parentDiscountPercent =
              e.newData.extreme_discount !== undefined
                ? e.newData.extreme_discount
                : e.oldData.extreme_discount;
            const parentBaseAmount =
              e.newData.baseamount || e.oldData.baseamount;
            const parentFullPriceWDiscount =
              parentBaseAmount * (1 - parentDiscountPercent / 100);
            const parentManualDiscountAmount =
              parentBaseAmount * (parentDiscountPercent / 100);

            const parentTax = quoteLinesData._array
              .filter(
                (item) =>
                  item.extreme_parentquoteline === e.oldData.quotedetailid
              )
              .reduce((sum, child) => {
                const discountedPrice =
                  child.priceperunit *
                  (1 - parentDiscountPercent / 100) *
                  child.quantity;
            ...
            const childManualDiscountAmounts = quoteLinesData._array
              ...
              .map(
                (child) =>
                  child.manualdiscountamount ||
                  child.baseamount * (parentDiscountPercent / 100)
              );
            ...
            const adjustedBaseAmounts = adjustProportionalAmounts(
              parentBaseAmount,
              childBaseAmounts
            );
            const adjustedChildFullPrices = adjustProportionalAmounts(
              parentFullPriceWDiscount,
              childFullPrices
            );
            const adjustedChildManualDiscountAmounts =
              adjustProportionalAmounts(
                parentManualDiscountAmount,
                childManualDiscountAmounts
              );
            const adjustedChildTaxAmounts = adjustProportionalAmounts(
              parentTax,
              childTaxAmounts
            );
            ...
            quoteLinesData._array
              ...
              .forEach((child, index) => {
                ...
                const newManualDiscountAmount =
                  adjustedChildManualDiscountAmounts[index];
                ...
                const supplierDiscountAmount =
                  child.extreme_supplierpriceperunit *
                  (child.extreme_supplierdiscount / 100);
                const pricePerUnitWithSupplierDiscount =
                  child.extreme_supplierpriceperunit - supplierDiscountAmount;
                const pricePerUnit = newBaseAmount / child.quantity;
                const pricePerUnitWithCustomDiscount =
                  pricePerUnit - newManualDiscountAmount / child.quantity;
                const pdPerUnit =
                ...
                const margin =
                  child.extreme_supplierpriceperunit !== 0
                ...
                if (child.priceperunit !== null && child.quantity !== null) {
                  ...
                  childRecord.extreme_fullpricewithdiscount =
                    newFullPriceWDiscount;
                  child.manualdiscountamount = newManualDiscountAmount;
                  childRecord.manualdiscountamount = newManualDiscountAmount;
                  child.extreme_discount =
                    e.newData.extreme_discount !== undefined
                      ? e.newData.extreme_discount
                      : child.extreme_discount;
                  childRecord.extreme_discount =
                    e.newData.extreme_discount !== undefined
                      ? e.newData.extreme_discount
                      : child.extreme_discount;
                }
            ...
            if (e.newData.extreme_discount || e.newData.extreme_discount === 0)
              record.extreme_discount = e.newData.extreme_discount; // Decimal
          }
          ...
          promises.push(
            Xrm.WebApi.updateRecord("quotedetail", `${e.key}`, record)
          );
        ...
        onContentReady(e) {
          ...
          e.component
            ...
            .resizeCompleted.remove(masterGridColumnResized);
          e.component
            .getView("columnHeadersView")
            .resizeCompleted.add(masterGridColumnResized);
    ...
    function masterGridColumnResized() {
      ...
      if (detailContainers.length) {
        for (var j = 0; j < detailContainers.length; j++) {
          var detailGridInstance = $(detailContainers.get(j)).dxDataGrid(
            "instance"
          );
          ...
          for (var i = 0; i < dataGrid.columnCount(); i++) {
            ...
            if (
              detailGridInstance.columnOption(i, "dataField") === "productid"
            ) {
              detailGridInstance.columnOption(
                i,
                "width",
                dataGrid.columnOption(i, "width") + 30
              );
              detailGridInstance.columnOption(
                i,
                "visibleWidth",
                dataGrid.columnOption(i, "visibleWidth") + 30
              );
            } else {
              detailGridInstance.columnOption(
                i,
                "width",
                dataGrid.columnOption(i, "width")
              );
              detailGridInstance.columnOption(
                i,
                "visibleWidth",
                dataGrid.columnOption(i, "visibleWidth")
              );
            }
          }
        ...
        async function success(results) {
          ...
          for (var i = 0; i < results.entities.length; i++) {
            ...
            const customDiscountAmount =
              pricePerUnit * (extreme_discount / 100);
            const pricePerUnitWithCustomDiscount =
              pricePerUnit - customDiscountAmount;
            const pdPerUnit =
              pricePerUnitWithCustomDiscount - pricePerUnitWithSupplierDiscount;
    ...
    async function onAdd(e) {
      ...
      if (e.fromData === "root" && e.itemData.extreme_isparentitem === false) {
        ...
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.toData
        ).baseamount =
          parseFloat(
            quoteLinesData._array.find(
              (item) => item.quotedetailid === e.toData
            ).baseamount
          ) + e.itemData.baseamount;
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.toData
        ).extendedamount =
          parseFloat(
        ...
        quoteLinesData._array.find(
          ...
          ) + e.itemData.extreme_fullpricewithdiscount;
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.toData
        ).manualdiscountamount =
          parseFloat(
          ...
          ) + e.itemData.manualdiscountamount;
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.toData
        ).extreme_supplierbaseamount =
          parseFloat(
          ...
          ) + e.itemData.extreme_supplierbaseamount;
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.toData
        ).tax =
          parseFloat(
        ...
        const newBaseAmountSum = parseFloat(
          quoteLinesData._array.find((item) => item.quotedetailid === e.toData)
            .baseamount
        );
        const newFullPriceWithDiscount = parseFloat(
          quoteLinesData._array.find((item) => item.quotedetailid === e.toData)
            .extreme_fullpricewithdiscount
        );
        quoteLinesData._array.find(
          ...
          ((newBaseAmountSum - newFullPriceWithDiscount) / newBaseAmountSum) *
          100;
        ...
        await Xrm.WebApi.updateRecord(
          "quotedetail",
          `${e.itemData.quotedetailid}`,
          { "extreme_ParentQuoteLine@odata.bind": `/quotedetails(${e.toData})` }
        );
        ...
        quoteLinesData._array.find(
          (item) => item.quotedetailid === e.fromData
        ).baseamount =
          parseFloat(
            quoteLinesData._array.find(
              (item) => item.quotedetailid === e.fromData
        ...
        await Xrm.WebApi.updateRecord(
          "quotedetail",
          `${e.itemData.quotedetailid}`,
          { "extreme_ParentQuoteLine@odata.bind": null }
        );
        ...
        const newBaseAmountSumFrom = parseFloat(
          quoteLinesData._array.find(
            (item) => item.quotedetailid === e.fromData
          ).baseamount
        );
        const newFullPriceWithDiscountFrom = parseFloat(
          quoteLinesData._array.find(
            (item) => item.quotedetailid === e.fromData
          ).extreme_fullpricewithdiscount
        );
        quoteLinesData._array.find(
          ...
          ((newBaseAmountSumFrom - newFullPriceWithDiscountFrom) /
            newBaseAmountSumFrom) *
          100;
        ...
        const newBaseAmountSumTo = parseFloat(
          quoteLinesData._array.find((item) => item.quotedetailid === e.toData)
            .baseamount
        );
        const newFullPriceWithDiscountTo = parseFloat(
          quoteLinesData._array.find((item) => item.quotedetailid === e.toData)
            .extreme_fullpricewithdiscount
        );
        quoteLinesData._array.find(
          ...
          ((newBaseAmountSumTo - newFullPriceWithDiscountTo) /
            newBaseAmountSumTo) *
          100;
